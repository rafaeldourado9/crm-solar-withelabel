...
MIDDLEWARE = [
    ...
    'config.middleware.DatabaseFallbackMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='crm_solar'),
...
DEFENDER_REDIS_URL = f"redis://{config('REDIS_HOST', default='localhost')}:{config('REDIS_PORT', default='6379')}/2"
